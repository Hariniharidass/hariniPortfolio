...
function projectCard(props) {
  ...
  return (
    <>
      <div className="lg:flex lg:flex-row justify-center items-center w-full m-5 p-4 mt-4 border-b-4 border-white-600 shadow-md  md:flex-col md:justify-center md:items-center sm:flex-col sm:justify-center sm:items-center text-center text-white">
        ...
        <div className="flex-col justify-center items-center m-2 p-2 lg:w-1/3 w-full">
          ...
          <ul className="list-disc">
            {props.details.map((detail, index) => (
              <li className="text-left text-m w-full" key={index}>
                {detail}
              </li>
            ))}
          </ul>
